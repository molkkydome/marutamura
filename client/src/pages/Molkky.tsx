/*
 * Molkky Rules Page - Zero Scroll with Rotated Image
 */
...
export default function Molkky() {
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      <header className="bg-primary text-primary-foreground py-3 shadow-lg flex-shrink-0 relative overflow-hidden">
        ...
        <div className="container flex items-center justify-between relative z-10">
          <h1 className="text-lg font-bold">🎯 モルック</h1>
          <Link href="/">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="container h-full py-3">
          <div className="h-full flex flex-col gap-3">
            {/* Rules Image (Rotated 90 degrees for mobile) */}
            <div className="flex-1 min-h-0 overflow-y-auto">
              <img 
                src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663365208017/rnNOAFGAivqiMHYy.jpg"
                alt="モルックのルール"
